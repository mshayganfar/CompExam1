...
through out the collaboration; they need to be able to communicate with others
...
reconcile between commitments to the existing collabortion and their other
...
in the plan. Agents have a library of how to do their actions, i.e. recipes (see
...
well as termination of the collaboration with each agent mutually believing that
...
an action (botom of the figure). In the case of a group plan, having a mutual
...
defined to be a commitment to act in a certain mental state. In other words, an
...
team member in $\Theta$, requires $\mu$ to achieve p if it is false. However, if
...
establish mutual belief in $\Theta$; this commitment typically makes an agent
...
condition) of their having done the action, and having done it mutually
believing throughout that they were doing it (knowingly) \cite{cohen:teamwork}.
...
called unreconciled case in SharedPlans theory which in STEAM, it is handled by
...
borrows the concept of ``intention that'' from SharedPlans theory to help
generalization of STEAM's comminication capabilities beside what Joint
Intenitons theory offers.
