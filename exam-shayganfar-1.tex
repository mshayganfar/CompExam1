...
\cite{jennings:joint-responsibility-dynamic}. In \cite{kinny:planned-team} Kinny
et. al. introduce a language for representing joint plans for teams of agents
and describe how agents can organize the formation of a skilled team to achieve
a joint goal. They use joint intentions to capture the mental properties which
...
a collaboration in the Joint Intentions theory.
