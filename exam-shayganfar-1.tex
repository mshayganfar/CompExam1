...
The SharedPlans theory is based on the theories of Bratman and Pollack, who
outline a mental-state view of plans in which having a plan is not just knowing
how to do an action, but also having the intention to do the actions entailed.
Bratman's views of intention goes back to philosophical views of Anscombe and
$Casta\tilde{n}eda$ about intention \cite{anscombe:intention}
\cite{castaneda:thinking}.

Discourse segment pruposes are a natural extention of Gricean intentions at the
utterance level.
